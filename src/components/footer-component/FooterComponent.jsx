...
const FooterComponent = () => {
    return (
        <footer className="shadow bg-gray-950 m-0">
            <div className="w-full p-4 md:py-5">
                <div className="flex justify-center mb-3">
                    <div className="flex flex-wrap items-center justify-center sm:justify-start text-sm font-medium  text-slate-50">
                        <a href="https://femcoders.factoriaf5.org/" className="hover:text-amber-400 me-4 md:me-6 text-xl">Síguenos</a>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-center sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="text-sm text-slate-50 sm:text-right dark:text-slate-50">
                        Copyright© 2024 <a href="https://factoriaf5.org/" className="hover:underline hover:text-amber-400">Nutrilicious</a>
                    </div>
                </div>
