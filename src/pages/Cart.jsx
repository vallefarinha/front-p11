...
function Cart() {
    return (
        <>
                        <div className="w-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
                            <div className="flex md:flex-row flex-col justify-end" id="cart">
                                <div className="w-full bg-white" id="scroll">
                                    <div className="flex items-center text-gray-500 hover:text-gray-600 cursor-pointer">
                                        ...
                                        <Link to="/" className="text-sm pl-2 leading-none">Voltar</Link>
                                    </div>
                                    <p className="text-5xl font-black leading-10 text-gray-800 pt-3">Carrinho</p>
                                    <div className="md:flex items-center mt-14 py-8 border-t border-gray-200">
                                        <div className="w-1/4">
                                            <img src={azul} alt className="w-full h-full object-center object-cover" />
                                        </div>
                                ...
                                <div className="xl:w-1/2 md:w-1/3 xl:w-1/4 w-full bg-gray-100 h-full">
                                    <div className="flex flex-col md:h-screen px-14 py-20 justify-between  overflow-y-auto overflow-x-hidden">
                                        <div>
